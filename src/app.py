...
# App title
st.title("🧠 Adaptive NCERT RAGL Chatbot")
                    ...
                    try:
                        ...
                        if file.type == "application/pdf":
                            ...
                            try:
                                ...
                                content = df.head(10).to_string()  # Only first 10 rows
                            except Exception as e:
...
with col1:
    st.markdown("""
    <div style="border-radius: 10px; padding: 20px; background-color: #fef3c7; text-align: center; box-shadow: 2px 2px 8px rgba(0,0,0,0.1);">
        <div style="font-size: 40px;">🧪</div>
        <h4>Quiz Generator</h4>
        <p>Create smart quizzes from uploaded content.</p>
        <a href="/QUIZ" target="_self"><button style="padding: 8px 16px; border: none; background-color: #facc15; border-radius: 5px; cursor: pointer;">Go</button></a>
    </div>
    """, unsafe_allow_html=True)

with col2:
    st.markdown("""
    <div style="border-radius: 10px; padding: 20px; background-color: #e0f2fe; text-align: center; box-shadow: 2px 2px 8px rgba(0,0,0,0.1);">
        <div style="font-size: 40px;">👩‍🏫</div>
        <h4>Teacher Dashboard</h4>
        <p>Manage classes, assignments, and analyze learning data.</p>
        <a href="/teacher_dashboard" target="_self"><button style="padding: 8px 16px; border: none; background-color: #38bdf8; color: white; border-radius: 5px; cursor: pointer;">Go</button></a>
    </div>
    """, unsafe_allow_html=True)

with col3:
    st.markdown("""
    <div style="border-radius: 10px; padding: 20px; background-color: #d1fae5; text-align: center; box-shadow: 2px 2px 8px rgba(0,0,0,0.1);">
        <div style="font-size: 40px;">🎓</div>
        <h4>Student Dashboard</h4>
        <p>Track progress, take quizzes, and review learning.</p>
        <a href="/student_dashboard" target="_self"><button style="padding: 8px 16px; border: none; background-color: #34d399; color: white; border-radius: 5px; cursor: pointer;">Go</button></a>
    </div>
    """, unsafe_allow_html=True)
