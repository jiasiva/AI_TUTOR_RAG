...
with col1:
    st.page_link("pages/1_QUIZ.py", label="🧪 Quiz Generator", icon="🧪")

with col2:
    st.page_link("pages/3_teacher.py", label="👩‍🏫 Teacher Dashboard", icon="👩‍🏫")

with col3:
    st.page_link("pages/2_student.py", label="🎓 Student Dashboard", icon="🎓")
